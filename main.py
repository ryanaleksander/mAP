...
img_path = '/storage/anhlt/mAP/images'
...
results_files_path = "/storage/anhlt/mAP/results"
...
ground_truth_files_list = glob.glob('/storage/anhlt/mAP/ground-truth/*.txt')
...
for txt_file in ground_truth_files_list:
  ...
  if not os.path.exists('/storage/anhlt/mAP/predicted/' + file_id + ".txt"):
...
predicted_files_list = glob.glob('/storage/anhlt/mAP/predicted/*.txt')
...
for class_index, class_name in enumerate(gt_classes):
  ...
  for txt_file in predicted_files_list:
    ...
    file_id = os.path.basename(os.path.normpath(file_id))
    if class_index == 0:
      if not os.path.exists('/storage/anhlt/mAP/ground-truth/' + file_id + ".txt"):
